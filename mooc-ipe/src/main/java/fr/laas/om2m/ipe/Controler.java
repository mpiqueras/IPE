...
import fr.laas.mooc.helper.sparql.SparqlQueries;
import fr.laas.mooc.helper.virtual.LuminositySensor;
...
public class Controler {
	public static void main(String[] args) {
		...
		ipe.createPlatform(sm.getId(), new Platform("Home_Platform",
		T_Room.BEDROOM));
		ipe.createPlatform(sm.getId(), new Platform("Garden_Platform",
		T_Room.LIVINGROOM));
		System.out.println("fini?");
		while(true);
		/*ipe.addSensor(sm.getId(), "Home_Platform", new
		TemperatureSensor("Bedroom_Thermometer", T_Room.BEDROOM));
		ipe.addSensor(sm.getId(), "Home_Platform", new
		TemperatureSensor("Livingroom_Thermometer", T_Room.LIVINGROOM));
		ipe.addSensor(sm.getId(), "Home_Platform", new
		TemperatureSensor("Bedroom_Thermometer", T_Room.BEDROOM));
		ipe.addSensor(sm.getId(), "Garden_Platform", new
		TemperatureSensor("Garden_Thermometer", T_Room.GARDEN));
